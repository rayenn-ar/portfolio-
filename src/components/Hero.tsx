...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="hero-orb w-[500px] h-[500px] bg-accent top-[-100px] left-[-100px]" />
      <div
        className="hero-orb w-[400px] h-[400px] bg-accent-secondary bottom-[-50px] right-[-50px]"
        style={{ animationDelay: "3s" }}
      />
      <div
        className="hero-orb w-[300px] h-[300px] bg-accent top-[60%] left-[50%]"
      ...
      >
        ...
        {/* Subtitle */}
        <p className="text-xl sm:text-2xl text-accent font-medium mb-6 animate-fade-in-up animation-delay-200">
          {personalInfo.title}
        </p>
        ...
        {/* Social links */}
        <div className="flex items-center justify-center gap-6 mt-12 animate-fade-in-up animation-delay-500">
          <a
