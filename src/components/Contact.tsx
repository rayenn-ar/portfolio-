        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className={`space-y-4 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}>
            ...
            <a href={`tel:${personalInfo.phone}`} className="glass-card p-5 flex items-center gap-4 group cursor-pointer block">
              ...
              <div>
                <p className="text-text-muted text-xs uppercase tracking-wider">Téléphone</p>
            ...
            <div className="glass-card p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-text-muted text-xs uppercase tracking-wider">Localisation</p>
            ...
            <a href={personalInfo.github} target="_blank" rel="noopener noreferrer" className="glass-card p-5 flex items-center gap-4 group cursor-pointer block">
              ...
              <div>
                <p className="text-text-muted text-xs uppercase tracking-wider">GitHub</p>
                <p className="text-text-primary font-medium group-hover:text-accent transition-colors">github.com/rvyen.ayari</p>
              </div>
            </a>
          </div>
          ...
          <div className={`transition-all duration-700 delay-400 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}>
            <form className="glass-card p-8 space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                ...
                <textarea id="contact-message" rows={4} placeholder="Votre message..." className="w-full px-4 py-3 rounded-xl bg-white/5 border border-border text-text-primary placeholder-text-muted focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all resize-none" />
              </div>
