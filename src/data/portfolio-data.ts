...
export const projects = [
  {
    id: 1,
    title: "Yassin Shop — Application POS Superette",
    description:
      "Application POS (Point of Sale) complète pour la gestion d'une supérette : caisse enregistreuse, suivi des ventes, gestion des stocks et des fournisseurs. Fonctionne 100% hors ligne.",
    role: "Développeur freelance — conception, développement, déploiement.",
    technologies: ["JavaScript", "React", "Node.js", "Electron"],
    type: "Mission Freelance",
    date: "2026",
    results: [
      "Caisse enregistreuse opérationnelle",
      "Gestion des stocks en temps réel",
      "Mode offline 100% fonctionnel",
    ],
    github: "https://github.com/rayenn-ar/yassin-shop",
    demo: "#",
    image: "/projects/gestion-caisse.jpg",
  },
  {
    id: 2,
    title: "Gestion Supérette",
    description:
      "Système de gestion complet pour supérette : inventaire, dépôts fournisseurs, suivi des ventes et tableaux de bord statistiques adaptés aux petits commerces locaux.",
    role: "Développeur freelance — conception, développement, optimisation.",
    technologies: ["React", "Node.js", "Electron", "Tauri"],
    type: "Freelance / Indépendant",
    date: "2026",
    results: [
      "Interface rapide et ergonomique",
      "Gestion des ventes, stocks, statistiques",
      "Application desktop performante",
    ],
    github: "https://github.com/rayenn-ar/gestion-superette",
    demo: "#",
    image: "/projects/gestion-caisse.jpg",
  },
  {
    ...
    description:
      "Boutique en ligne moderne avec gestion de catalogue, panier d'achat, authentification et interface responsive. Développée avec React, TypeScript et Redux Toolkit.",
    ...
    github: "https://github.com/rayenn-ar/E-commerce",
    demo: "#",
    image: "/projects/ecommerce.jpg",
  },
  {
    id: 4,
    title: "App de Gestion — Salon de Coiffure",
    description:
      "Application web fullstack sur mesure pour la gestion complète d'un salon de coiffure : prise de rendez-vous en ligne, gestion des clients, des employés et des services.",
    role: "Développeur freelance — conception, développement, déploiement.",
    ...
    results: [
      ...
      "Gestion complète des clients et rendez-vous",
      "Base de données relationnelle avec Prisma ORM",
    ],
    github: "https://github.com/rayenn-ar/salon-coiffure-app",
    demo: "#",
  ...
  },
  {
    ...
    description:
      "Portfolio professionnel full-stack développé avec Next.js 15 et TypeScript, incluant un panneau d'administration pour gérer les projets, compétences et expériences en temps réel.",
    role: "Développeur fullstack — conception, design, développement, déploiement.",
    technologies: ["Next.js", "TypeScript", "TailwindCSS", "React"],
    type: "Projet Personnel",
    date: "2026",
    results: [
      "Interface moderne et responsive",
      "Panneau admin avec gestion en temps réel",
      "Déployé sur Vercel",
    ],
    github: "https://github.com/rayenn-ar/portfolio-",
    demo: "https://portfolio-blue-gamma-ma9bljwnyv.vercel.app",
